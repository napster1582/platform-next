                ...
                <ol class="max-h-[500px] overflow-y-clip border-l border-white/20 p-4">
                    {#each items as item, index}
                        <li class="relative -left-7 mb-16 text-white">
                            <button
                                class="rounded-token border bg-transparent bg-white px-2 py-0.5 font-medium hover:bg-white/70"
...
<style lang="postcss">
    .carousel {
        @apply bg-gray-950 bg-cover bg-center bg-no-repeat bg-blend-soft-light;
    }
