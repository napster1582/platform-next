...
<Link
    {href}
    className="text-gray-400 inline-flex justify-center items-center p-5 font-semibold bg-gray-950 rounded-token hover:text-blue-400 hover:bg-gray-900 w-full"
>
    <!-- prettier-ignore -->
    <slot name="icon">        
    ...
    <!-- prettier-ignore -->
    <span class="icon-[radix-icons--external-link] text-2xl" />
</Link>
