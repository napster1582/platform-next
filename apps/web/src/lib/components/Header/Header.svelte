...
<header
    class="bg-primary-700/80 dark fixed inset-x-0 top-0 z-20 h-[70px] -translate-y-[70px] text-white shadow-2xl backdrop-blur-md transition-transform duration-300"
