<script lang="ts">
    ...
    // import iconTwitter from '$lib/assets/icons/twitter.png';

    // import backdropFacebook from '$lib/assets/images/TMP_backdrop_0.jpg';
    ...
    //     {
    //         name: 'Facebook',
    //         backdrop: backdropFacebook,
    //         icon: iconFacebook,
    //         link: '#',
    //     },
    //     {
    //         name: 'Instagram',
    //         backdrop: backdropInstagram,
    //         icon: iconInstagram,
    //         link: '#',
    //     },
    //     {
    //         name: 'Twitter',
    //         backdrop: backdropTwitter,
    //         icon: iconTwitter,
    //         link: '#',
    //     },
    //     {
    //         name: 'Linkedin',
    //         backdrop: backdropLinkedin,
    //         icon: iconLinkedin,
    //         link: '#',
    //     },
    // ];
...
<!-- <div
    class="lg:gap-18 my-24 grid grid-cols-1 gap-16 rounded-xl bg-gray-100 p-12 md:grid-cols-2 md:gap-8 lg:grid-cols-4"
>
