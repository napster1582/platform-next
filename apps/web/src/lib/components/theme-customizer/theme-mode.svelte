<script lang="ts">
	...
	let selectedMode = themes.find((theme) => theme.value === getThemeMode())!;

	$: {
		setThemeMode(selectedMode.value);
	}
</script>
